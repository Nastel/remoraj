...
public class JMSCreateConnectionAdvice extends BaseTranformers implements RemoraAdvice{
                              ...
                              @Advice.Local("starttime") long starttime) //
    {
        try {
            ...
            if (isChainedClassInterception(JMSCreateConnectionAdvice.class)) return; // return if its chain of same
