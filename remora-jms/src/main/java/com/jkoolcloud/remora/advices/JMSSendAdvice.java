...
public class JMSSendAdvice extends BaseTranformers implements RemoraAdvice {
                              ...
                              @Advice.Local("starttime") long starttime) //
    {
        try {
            ...
            if (isChainedClassInterception(JMSSendAdvice.class)) return; // return if its chain of same
