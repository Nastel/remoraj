...
public class JMSServer extends HttpServlet implements Runnable
{
	...
	public void init() throws ServletException
	{
		...
		catch (NamingException e) { ; } // If this is WAS, this will fail.  Fall thru
		...
		catch (NamingException e) { System.out.println("JNDI API lookup failed: " + e.toString()); }
	...
	public void run()
	{
		 ...
		 * not transacted. Create receiver, then start message delivery. Receive all
		 * text messages from queue until a non-text message is received indicating
		 * end of message stream. Close connection.
		 */
		try
		{
