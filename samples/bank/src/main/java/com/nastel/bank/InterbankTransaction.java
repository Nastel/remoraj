...
public class InterbankTransaction extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("    <td class=label style=\"border-bottom: solid 1px white\" width=50% align=right>Remote Bank:</td>");
        out.println("    <td class=value align=center width=40%>");
        out.println("      <input size=30 name=\"remote\">");
        out.println("    </td>");
        out.println("  </tr>");
        out.println("  <tr class=info_body>");
        out.println("    <td class=label style=\"border-bottom: solid 1px white\" width=50% align=right>Implementation:</td>");
        out.println("    <td class=value align=center width=40%>");
        ...
        out.println("        <option name=\"HttpUrlConnection\" value=\"HttpUrlConnection\">HttpUrlConnection</option>");
        ...
        out.println("    <td class=info_body align=center colspan=3>" +
    ...
    private void receiveMoneyHttpUrlConnection(String remoteServer) throws IOException {
        ...
        HttpURLConnection httpClient =
                (HttpURLConnection) new URL(remoteServer).openConnection();
