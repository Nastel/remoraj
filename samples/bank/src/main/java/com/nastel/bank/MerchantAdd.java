...
public class MerchantAdd extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(
				"    <td class=label style=\"border-bottom: solid 1px white\" align=right width=40%>Merchant:</td>");
		...
		out.println("  <tr class=info_body>");
		out.println(
				"    <td class=info_body align=center colspan=2><input type=submit name=submit value='Create'></td>");
		out.println("  </tr>");
		out.println("</table>");
		out.println("</form>");
		...
		UITemplate.infoBox(out,
				"The Merchant Add function allows the banking user to create a new payable merchant within the system.  The underlying code will perform a JDBC insert.");
