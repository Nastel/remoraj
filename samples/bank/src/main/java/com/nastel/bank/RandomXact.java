...
public class RandomXact extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		UITemplate.infoBox(out, "The Random Transaction Generator will insert a number of different banking transactions, including ATM, Checks and deposits.  The generator will add deposits when the balance is approaching 0.  The user controls how many transactions are added.");
