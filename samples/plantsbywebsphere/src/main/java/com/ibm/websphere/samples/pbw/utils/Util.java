...
public class Util {
	...
	private static final String[] SHIPPING_METHOD_TIMES = { "( 3 to 6 business days )", "( 2 to 3 business days )",
	 ...
	 * 
	 * @param index
	 *            The int representation of a category.
	 ...
	 * 
	 * @param index
	 *            The int representation of a shipping method.
	...
	/**
	 * Utilty functions for validating user input. validateString will return false if any of the invalid characters
	 * appear in the input string.
	 *
	 * In general, we do not want to allow special characters in user input, because this can open us to a XSS security
	 * vulnerability. For example, a user should not be allowed to enter javascript in an input field.
	 */
