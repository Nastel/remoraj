...
public class SpringTransactionAdvice extends BaseTransformers implements RemoraAdvice {
	...
	public static void before(@Advice.This Object thiz, //
		...
		try {
			...
			logger.info("Entering: {} {}", SpringTransactionAdvice.class.getName(), ctx.interceptorInstance, "before");
	...
	public static void after(@Advice.This Object obj, //
		...
		try {
			...
			logger.info("Exiting: {} {}", SpringTransactionAdvice.class.getName(), ctx.interceptorInstance, "after");
